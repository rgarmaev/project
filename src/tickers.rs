pub const TICKERS: &[&str] = &[
    ...
    // ── Additional top-volume ────────────────────────────────────────────────
    "ENJUSDT", "BATUSDT", "REEFUSDT", "ROSEUSDT", "NKNUSDT",
    "LRCUSDT", "LPTUSDT", "STGUSDT", "SPELLUSDT", "PEOPLEUSDT",
    "BELUSDT", "PHBUSDT", "DUSKUSDT", "SXPUSDT", "LITUSDT",
    "KNCUSDT", "RSRUSDT", "SCUSDT", "RENUSDT", "HNTUSDT",
    "TWTUSDT", "SUNUSDT", "XECUSDT", "GLMRUSDT", "GTCUSDT",
    "HIGHUSDT", "LOOMUSDT", "POLSUSDT", "REQUSDT", "PORTOUSDT",
    "BEAMXUSDT", "MANTLEUSDT", "GASUSDT", "BTTCUSDT", "WEMIXUSDT",
];
